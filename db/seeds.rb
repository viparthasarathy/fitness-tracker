...
90.times do |i|
  ...
  Measurement.create(entry: entry, weight: 200.0 - i/3.0, height: 72.0, waist: 37.0 - i/20.0, chest: 60.0 - i/30.0, bodyfat: 24.5 - i/10.0)
  entry.foods.create(name: "Food for day #{i + 1}", calories: rand(2000..2500), protein: rand(100..150), carbs: rand(100..150), fats: rand(100..150))
end
...
90.times do |i|
  ...
  params = {entry: entry, weight: measurement.weight + i/6.0, height: 72.0, waist: measurement.waist + i/40.0, chest: measurement.chest + i/20.0, bodyfat: measurement.bodyfat + i/20.0}
  Measurement.create(params)
  entry.foods.create(name: "Food for day #{i + 1}", calories: rand(2500..3000), protein: rand(125..175), carbs: rand(125..175), fats: rand(125..175))
end
...
90.times do |i|
  entry = third_chapter.entries.create(day: third_chapter.created_at + i.days)
  measurement = second_chapter.entries.first.measurement
  params = {entry: entry, weight: measurement.weight - i/3.0, height: 72.0, waist: measurement.waist - i/20.0, chest: measurement.chest - i/30.0, bodyfat: measurement.bodyfat - i/10.0}
  Measurement.create(params)
  entry.foods.create(name: "Food for day #{i + 1}", calories: rand(2000..2500), protein: rand(100..150), carbs: rand(100..150), fats: rand(100..150))
end
...
90.times do |i|
  entry = fourth_chapter.entries.create(day: fourth_chapter.created_at + i.days)
  measurement = third_chapter.entries.first.measurement
  params = {entry: entry, weight: measurement.weight - i/90.0, height: 72.0, waist: measurement.waist - i/300.0, chest: measurement.chest - i/400.0, bodyfat: measurement.bodyfat - i/90.0}
  Measurement.create(params)
  entry.foods.create(name: "Food for day #{i + 1}", calories: rand(2250..2750), protein: rand(125..150), carbs: rand(125..150), fats: rand(125..150))
end
